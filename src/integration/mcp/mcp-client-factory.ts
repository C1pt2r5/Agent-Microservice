...
export class MCPClientFactory {
   ...
   */
  static createDevelopmentClient(gatewayUrl: string = 'http://localhost:8080'): MCPClient {
   ...
   */
  static createTestClient(mockGatewayUrl: string = 'http://localhost:9999'): MCPClient {
    const config: MCPConfig = {

...
exports.A2AMessageRouter = void 0;
const events_1 = require("events");
class A2AMessageRouter extends events_1.EventEmitter {
     ...
     */
    addSubscription(agentId, subscription) {
     ...
     */
    removeSubscription(agentId, topic) {
    ...
    async routeMessage(message) {
        try {
            ...
            const deliveryPromises = recipients.map(agentId => this.deliverToAgent(processedMessage, agentId));
     ...
     */
    async executeRoutingAction(message, action) {
        switch (action.type) {
            case 'forward':
     ...
     */
    forwardMessage(message, parameters) {
     ...
     */
    transformMessage(message, parameters) {
     ...
     */
    filterMessage(message, parameters) {
     ...
     */
    duplicateMessage(message, parameters) {
     ...
     */
    async delayMessage(message, parameters) {
...
exports.A2AMessageRouter = A2AMessageRouter;

...
exports.GeminiClientFactory = void 0;
const gemini_client_1 = require("./gemini-client");
class GeminiClientFactory {
    static createClient(configOrApiKey, options) {
        if (typeof configOrApiKey === 'string') {
            ...
            return new gemini_client_1.GeminiClient(config);
        }
        return new gemini_client_1.GeminiClient(configOrApiKey);
    }
    /**
     * Create a Gemini client for development with default settings
     */
    static createDevelopmentClient(apiKey) {
        const config = {
     ...
     */
    static createProductionClient(apiKey, options = {}) {
        const config = {
            apiKey,
     ...
     */
    static createChatbotClient(apiKey) {
        const config = {
            apiKey,
            model: 'gemini-pro',
            endpoint: 'https://generativelanguage.googleapis.com/v1beta',
     ...
     */
    static createAnalyticalClient(apiKey) {
        const config = {
            apiKey,
            model: 'gemini-pro',
            endpoint: 'https://generativelanguage.googleapis.com/v1beta',
     ...
     */
    static createRecommendationClient(apiKey) {
        const config = {
            apiKey,
            model: 'gemini-pro',
            endpoint: 'https://generativelanguage.googleapis.com/v1beta',
     ...
     */
    static createClientSuite(apiKey) {
        return {
            chatbot: this.createChatbotClient(apiKey),
     ...
     */
    static async testClient(client) {
     ...
     */
    static createSafeClient(apiKey, safetyLevel = 'moderate') {
        const config = {
            apiKey,
            model: 'gemini-pro',
            endpoint: 'https://generativelanguage.googleapis.com/v1beta',
        ...
        const client = new gemini_client_1.GeminiClient(config);
...
exports.GeminiClientFactory = GeminiClientFactory;
//# sourceMappingURL=gemini-client-factory.js.map